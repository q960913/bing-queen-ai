package com.bing.queen.ai.common.utils.file;
...
import com.bing.queen.ai.common.exception.file.FileNameLengthLimitExceededException;
import com.bing.queen.ai.common.exception.file.FileSizeLimitExceededException;
import com.bing.queen.ai.common.exception.file.InvalidExtensionException;
import com.bing.queen.ai.common.utils.DateUtils;
import com.bing.queen.ai.common.utils.StringUtils;
import com.bing.queen.ai.common.utils.uuid.IdUtils;
import com.bing.queen.ai.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BingQueenAiConfig.getProfile();
    ...
    {
        int dirLastIndex = BingQueenAiConfig.getProfile().length() + 1;
